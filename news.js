       ...
       class MenuController {
            ...
            initializeEventListeners() {
                ...
                document.addEventListener('click', (e) => {
                    if (this.isMenuOpen && !this.dropdownMenu.contains(e.target)) {
                        this.closeMenu();
                    }
                });
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // You can access the menu controller globally:
            // window.menuController.setMenuState(true); // to open menu
            // window.menuController.setMenuState(false); // to close menu
            // window.menuController.getMenuState(); // to check if menu is open
        });

        // Optional: Add some demo interactions
        document.addEventListener('DOMContentLoaded', () => {
            // Add a subtle welcome animation
            setTimeout(() => {
                const menuButton = document.getElementById('menuButton');
                menuButton.style.animation = 'pulse 0.5s ease-in-out';
