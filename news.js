      class LiveNewsHub {
            ...
            createNewsCard(article, index) {
                ...
                const hasVideo = this.detectVideoContent(article);
                ...
                cardElement.innerHTML = `
                    <div class="card news-card h-100 ${isCached ? 'cached' : ''}" 
                        ...
                        ${hasVideo ? '<div class="cache-indicator-card" style="background: var(--breaking-color); top: 40px;"><i class="bi bi-play-circle"></i></div>' : ''}
                        <img 
                        ...
                        <div class="card-body d-flex flex-column">
                            <div class="source-info">
                                <div class="d-flex align-items-center">
                                    ...
                                    ${hasVideo ? '<i class="bi bi-play-circle text-danger ms-2" title="Video Available"></i>' : ''}
                                </div>
            ...
            detectVideoContent(article) {
                // Check if article contains video-related keywords or URLs
                ...
                return videoKeywords.some(keyword => content.includes(keyword)) || 
                       (article.urlToImage && article.urlToImage.includes('video')) ||
                       Math.random() > 0.7; // Simulate video availability for demo
            }
            ...
            showVideoModal() {
                const { title, url, source, hasVideo } = this.currentArticleData;
                ...
                document.getElementById('videoPlayerContainer').innerHTML = videoContent;
            ...
            toggleFullscreen() {
                const videoPlayer = document.querySelector('.video-player-centered');
                if (videoPlayer) {
